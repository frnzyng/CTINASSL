...
class UserAccountModel {
    ...
    public static function recordActivityLog($account_id, $action, $ip_address) {
        try {
            $servername = "localhost";
            $dbUsername = "root";
            $dbPassword = "";
            ...
            $stmtAuthenticate = $db->prepare("SELECT account_id, username, password FROM tblUserAccounts WHERE account_id = :account_id");
            ...
            $stmtRecordLog = $db->prepare("INSERT INTO tblUserActivityLog (account_id, username, action, datetime, ip_address) VALUES (:account_id, :username, :action, NOW(), :ip_address)");
