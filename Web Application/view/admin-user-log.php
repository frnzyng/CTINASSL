...
<head>
    ...
    <title>BlogSite - User Log</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-T3c6CoIi6uLrA9TneNEoa7RxnatzjcDSCmG1MXxSR1GAsXEV/Dwwykc2MPK8M2HN" crossorigin="anonymous">
    <link rel="stylesheet" href="css/admin-main.css">
    <link rel="stylesheet" href="css/admin-user-log.css">
    ...
    <div class="container px-0">
        <div class="row justify-content-center align-items-center mx-2">
            <?php
                ...
                try {
                    // Get all user logs
                    $userLogs = AdminAccountManagementController::handleUserLogRetrieval();
                } 
                catch (Exception $e) {
            ...
            <div class="user-log-block">
                ...
                <table class="table table-hover" id="table-user-accounts">
                        ...
                        <tbody class="table-group-divider">
                            ...
                            <tr>
                                <td><?php echo $userLog['log_id']?></td>
                                <td><?php echo $userLog['account_id']?></td>
                                <td><?php echo $userLog['username']?></td>
                                <td><?php echo $userLog['datetime']?></td>
