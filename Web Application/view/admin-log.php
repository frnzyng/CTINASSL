...
<head>
    ...
    <title>BlogSite - Admin Log</title>
    ...
    <div class="container px-0">
        <div class="row justify-content-center align-items-center mx-2">
            <?php
                ...
                try {
                    // Get all admin log
                    $adminLogs = AdminSettingsController::handleAdminLogRetrieval();
                } 
                catch (Exception $e) {
            ...
            <div class="admin-log-block">
                ...
                <table class="table table-hover" id="table-user-accounts">
                        ...
                        <tbody class="table-group-divider">
                            ...
                            <tr>
                                <td><?php echo $adminLog['log_id']?></td>
                                <td><?php echo $adminLog['account_id']?></td>
                                <td><?php echo $adminLog['username']?></td>
                                <td><?php echo $adminLog['datetime']?></td>
                                <td><?php echo $adminLog['action']?></td>
                                <td><?php echo $adminLog['ip_address']?></td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
